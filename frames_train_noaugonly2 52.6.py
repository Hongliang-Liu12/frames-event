...
if __name__ == "__main__":
    ...
    file_prefix = f"{SEED}_{Freeze_Epoch}_{Freeze_Lr}_{UnFreeze_Lr}_4"
...
# 2. 检查 log_dir 中是否有任何文件以此为前缀
    ...
    # [!!] 填入您刚刚保存的 "A" 模型的路径 [!!]
    resume_model_A_path = './logs/newtwostage/all2newstart1/42_12_0.0001_0.0001_ep007_model_map-0.4976.pth'
    # [!!] 填入您刚刚保存的 "B" 模型的路径 [!!]
    resume_model_B_path = './logs/newtwostage/all2newstart1/42_12_0.0001_0.0001_ep007_model_EMA_map-0.4976.pth'    
